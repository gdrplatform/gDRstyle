...
## Style guide
See the written [Style guide](https://github.com/gdrplatform/gDRstyle/blob/gh-pages/style_guide.md). The function `lintPkgDirs` can be used to ensure the package is appropriately linted. 
## CI/CD
