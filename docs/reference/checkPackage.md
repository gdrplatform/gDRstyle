...
#> 
#> ── R CMD check ─────────────────────────────────────────────────────────────────
#> * using log directory ‘/tmp/RtmpS7b3mM/file1cf72cc8f56c/fakePkg.Rcheck’
...
#> * current time: 2026-06-02 11:25:50 UTC
...
#> Status: 1 NOTE
#> See
#>   ‘/tmp/RtmpS7b3mM/file1cf72cc8f56c/fakePkg.Rcheck/00check.log’
#> for details.
#> Finished
#> ##------ Tue Jun  2 11:25:57 2026 ------##
```
